          ...
          <DropdownMenu>
            <DropdownMenuTrigger as-child>
              <button class="hover:ring-border flex items-center gap-2 rounded-lg px-1 py-0.5 transition-colors hover:ring-2">
                <Avatar class="size-7">
                  <AvatarFallback class="bg-primary text-primary-foreground text-xs font-semibold">AD</AvatarFallback>
                </Avatar>
                <div class="hidden text-left md:block">
                  <p class="text-sm font-medium leading-none">Admin User</p>
                  <p class="text-muted-foreground text-xs">admin@example.com</p>
                </div>
              </button>
            </DropdownMenuTrigger>
